...
#define CDSITX_SIDEBAND_COUNT_CONFIG_00_VAL   0x00000f94
...
static void lg4892_cdsi_init_cmd(struct cdsi_dev *dev)
{
    ...
    cdsi_write(dev, CDSI0_CDSITX_PLL_CONFIG_00_OFFS,
               CDSITX_PLL_CONFIG_00_VAL);
    cdsi_write(dev, CDSI0_CDSITX_PLL_CONFIG_02_OFFS,
               CDSITX_PLL_CONFIG_02_VAL);
    ...
    cdsi_write(dev, CDSI0_CDSITX_LANE_ENABLE_02_OFFS,
               CDSITX_LANE_ENABLE_00_VAL);
    cdsi_write(dev, CDSI0_CDSITX_VREG_CONFIG_OFFS,
               CDSITX_VREG_CONFIG_VAL);
    cdsi_write(dev, CDSI0_CDSITX_VREG_CONTROL_OFFS,
               CDSITX_VREG_CONTROL_VAL);
    cdsi_write(dev, CDSI0_CDSITX_LPRX_CALIB_CONFIG_OFFS,
               CDSITX_LPRX_CALIB_CONFIG_VAL);
    cdsi_write(dev, CDSI0_CDSITX_LPRX_CALIB_CONTROL_OFFS,
               CDSITX_LPRX_CALIB_CONTROL_VAL);
